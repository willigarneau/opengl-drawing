...
void handleMenuFunctions(int value)
{
	...
	if (value == 4) { tool.setSelectedTool(1); painting.ClearWindow(point, line, triangle, quad, pencil); }
	if (value == 5) { tool.setSelectedTool(2); painting.ClearWindow(point, line, triangle, quad, pencil); }
	if (value == 6) { tool.setSelectedTool(3); painting.ClearWindow(point, line, triangle, quad, pencil); }
	if (value == 7) { tool.setSelectedTool(4); painting.ClearWindow(point, line, triangle, quad, pencil); }
	if (value == 17) { tool.setSelectedTool(5); painting.ClearWindow(point, line, triangle, quad, pencil); }
	if (value == 0) { glutLeaveMainLoop(); painting.ClearWindow(point, line, triangle, quad, pencil); }
	if (value == -1) { painting.ClearWindow(point, line, triangle, quad, pencil); }
